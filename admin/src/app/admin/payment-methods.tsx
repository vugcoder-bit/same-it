...
export default function PaymentMethodsScreen() {
    ...
    const [color, setColor] = useState('#E8632B');
    ...
    const colors = ['#E8632B', '#3B82F6', '#22C55E', '#8B5CF6', '#F43F5E', '#64748B'];
    ...
    return (
        <View style={[styles.container, !isDesktop && { padding: 16 }]}>
            <View style={[styles.header, !isDesktop && { flexDirection: 'column', alignItems: 'flex-start', gap: 16 }]}>
                ...
                <Pressable 
                    onPress={() => { setEditingId(null); setTitle(''); setAccountNumber(''); setNote(''); setColor('#E8632B'); setModalVisible(true); }} 
